...
import com.maimai.kt.constants.HttpConstants
import com.maimai.kt.constants.PayloadKeys
import com.maimai.kt.crypto.TitleCodec
import com.maimai.kt.error.MaimaiRequestException
import com.maimai.kt.error.MaimaiResponseException
...
class TitleTransport(
    ...
    suspend fun postRaw(
        ...
        throw MaimaiResponseException("$apiName 多次重试后仍失败", lastError)
    }
...
/** 从 Set-Cookie 里提取 JSESSIONID 等 cookie。 */
...
/** 创建默认 HTTP 客户端；verifyTls=false 时对齐旧 Python verify=False 行为。 */
